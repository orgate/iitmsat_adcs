...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_TargetAttitudeGenerator_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_TargetAttitudeGenerator_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_TargetAttitudeGenerator_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_TargetAttitudeGenerator_autoinheritance_info(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_TargetAttitudeGenerator_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "TargetAttitudeGenerator") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_TargetAttitudeGenerator_get_eml_resolved_functions_info(nlhs,plhs,
      2,newRhs);
  }
...
extern unsigned int sf_TargetAttitudeGenerator_method_dispatcher(SimStruct *S,
...
{
  if (!strcmp(machineName,"TargetAttitudeGenerator")) {
    return(sf_TargetAttitudeGenerator_method_dispatcher(simstructPtr,
...
extern void TargetAttitudeGenerator_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    TargetAttitudeGenerator_terminator();
    sf_debug_terminate();
  }
...
extern void TargetAttitudeGenerator_initializer(void);
extern void TargetAttitudeGenerator_register_exported_symbols(SimStruct* S);
extern void TargetAttitudeGenerator_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  TargetAttitudeGenerator_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      TargetAttitudeGenerator_debug_initialize();
    }

    TargetAttitudeGenerator_initializer();
  }
