...
%function [satrec, startmfe, stopmfe, deltamin] = twoline2rv(whichconst, longstr1, longstr2, typerun,typeinput)
 function [satrec, startmfe, stopmfe, deltamin] = twoline2rv(satrec1, whichconst, longstr1, longstr2, typerun,typeinput)
...
%              startsec  = input('input start sec');
               startyear = satrec1.year;
               startmon  = satrec1.mon;
               startday  = satrec1.day;
               starthr   = satrec1.hr;
               startmin  = satrec1.min;
               startsec  = satrec1.sec;
%              jdstart = jday( startyear,startmon,startday,starthr,startmin,startsec );
               jdstart=satrec.jdsatepoch;
