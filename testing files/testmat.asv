...
%   3.1 (2 dec, 2008) - fix tsince/1440.0 in jd update
  ...
  function [time, rx, ry, rz] =testmat(yr, month, tday, hour, min, second,num,time_step)
...
%   typerun = input('input type of run c, v, m: ','s');
    typerun ='m';
    rx=10000*ones(1,50000);
    ry=10000*ones(1,50000);
    rz=10000*ones(1,50000);
    vx=10000*ones(1,50000);
    vy=10000*ones(1,50000);
    vz=10000*ones(1,50000);
    k=1;
...
%                // includes initialization of sgp4
            [satrec, startmfe, stopmfe, deltamin] = twoline2rv(satrec, whichconst, ...
                       longstr1, longstr2, typerun, typeinput, num, time_step);
