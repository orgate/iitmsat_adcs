...
%function [satrec, startmfe, stopmfe, deltamin] = twoline2rv(whichconst, longstr1, longstr2, typerun,typeinput)
 function [satrec, startmfe, stopmfe, deltamin] = twoline2rv(satrec, whichconst, longstr1, longstr2, typerun,typeinput,num,time_step)
...
%              jdstop = jday( stopyear,stopmon,stopday,stophr,stopmin,stopsec );
               deltaday =(num*time_step)/86400;
               jdstop =jdstart+deltaday;
